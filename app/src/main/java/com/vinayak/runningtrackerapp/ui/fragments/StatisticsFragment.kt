...
import com.vinayak.runningtrackerapp.ui.viewmodels.StatisticsViewModel
        ...
        statisticsViewModel.runsSortedByDate.observe(viewLifecycleOwner, Observer {
            it?.let {
                val allAvgSpeeds = it.indices.map {
                        i -> BarEntry(i.toFloat(), it[i].avgSpeedInKMH) // x axis -> i.toFloat() and y axis -> it[i].avgSpeedInKMH
                }
